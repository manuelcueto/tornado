...
public class TornadoService {
	...
	Jugador jugador = this.buscarJugador(nroDocumento);
	Equipo equipo = this.buscarEquipo(idEquipo);
	if (equipo.noEstaCompleto() && !jugador.tieneEquipo() && equipo.getCategoria().equals(jugador.getCategoria())) {
	...
	if (torneo.equipoAgregable(equipo)) {
	    ...
	    this.equipoRepo.updateAsignado(equipo.getIdEquipo(), true);
	}
    }
